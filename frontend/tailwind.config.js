...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        // Glow — brand indigo
        "glow-sm":      "0 0 14px -2px rgba(99,102,241,0.35)",
        "glow":         "0 0 28px -4px rgba(99,102,241,0.45)",
        "glow-lg":      "0 0 56px -8px rgba(99,102,241,0.55)",
        "glow-rose":    "0 0 28px -4px rgba(244,63,94,0.4)",
        "glow-emerald": "0 0 28px -4px rgba(16,185,129,0.4)",
        // Light mode card — Scalify-style clean layered shadow
        ...
        // Dark mode card — Demuxed-style deep glass shadow
      ...
      backgroundImage: {
        ...
        "brand-gradient-subtle": "linear-gradient(135deg,rgba(99,102,241,0.12) 0%,rgba(139,92,246,0.06) 100%)",
        // Scalify-inspired page mesh — very subtle radial brand glow at top
        "page-mesh-light":       "radial-gradient(ellipse 80% 40% at 50% -10%, rgba(99,102,241,0.07) 0%, transparent 70%)",
        "page-mesh-dark":        "radial-gradient(ellipse 80% 40% at 50% -10%, rgba(99,102,241,0.12) 0%, transparent 70%)",
      },
    },
  },
  plugins: [],
