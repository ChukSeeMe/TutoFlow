...
import { LogOut, LayoutDashboard, ClipboardList, BookOpen, Brain, Menu, X } from "lucide-react";
...
export default function StudentLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[rgb(237_239_248)] dark:bg-[#0a0a10]">
      <header className={cn(
        "sticky top-0 z-20 border-b px-4 sm:px-6 py-3 flex items-center justify-between gap-3",
